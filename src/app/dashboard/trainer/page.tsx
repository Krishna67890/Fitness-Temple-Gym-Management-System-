...
import { X, Check, Camera, User as UserIcon, Lock, Calendar as CalendarIcon, Ruler, Weight, Target, Shield, Mail as MailIcon } from "lucide-react";
              ...
              <form onSubmit={handleAddMember} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <MailIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-primary" size={16} />
